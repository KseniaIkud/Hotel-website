const btns = document.querySelectorAll('.example-counter__btn');

const adult = document.querySelector('#exampleAdults');
const children = document.querySelector('#exampleChildren');
const infants = document.querySelector('#exampleInfants');
