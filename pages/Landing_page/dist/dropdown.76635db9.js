...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/jquery-1.12.4.js":[function(require,module,exports) {
...
var _jquery = _interopRequireDefault(require("./jquery-1.12.4"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _jquery.default)('.text-field__dropdown-default').on('click', function () {
  var _this = this;

  (0, _jquery.default)(this).parent().find('.common-dropdown').removeClass('hidden');
  (0, _jquery.default)(this).addClass('border-focus');
  (0, _jquery.default)(document).on('click', function (e) {
    var el = '.common-dropdown';
    if ((0, _jquery.default)(e.target).closest(_this).length) return;
    if ((0, _jquery.default)(e.target).closest(el).length) return;
    (0, _jquery.default)(_this).parent().find('.common-dropdown').addClass('hidden');
    (0, _jquery.default)(_this).removeClass('border-focus');
  });
});
},{"./jquery-1.12.4":"js/jquery-1.12.4.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
