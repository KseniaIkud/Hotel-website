...
},{"process":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"js/dropdown-guests-default.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)('.guests-counter__btn').on('click', function () {
  var countGuests = function countGuests(_this) {
    var direction = (0, _jquery.default)(_this).attr('data-direction');
    var input = (0, _jquery.default)(_this).parent().find('.counter__value');
    ...
    if (direction === 'plus') {
      ...
      var _newValue = value > 0 ? value - 1 : 0;
  ...
  var clearValues = function clearValues(elements) {
  ...
  var setPlaceholder = function setPlaceholder(bar, value) {
    bar.attr({
      'placeholder': value
    });
  };

  var setAddPlaceholder = function setAddPlaceholder(bar, additionValue) {
    bar.attr({
      'placeholder': "".concat(bar.attr('placeholder'), ", ").concat(additionValue)
    });
  };

  var declineWord = function declineWord(word, value) {
    if ((value < 10 || value > 20) && value % 10 === 1 && value % 100 !== 11) {
      switch (word) {
        case 'Гость':
          return 'гость';
    ...
    if ((value % 10 === 2 || value % 10 === 3 || value % 10 === 4) && value % 100 !== 12 && value % 100 !== 13 && value % 100 !== 14) {
      switch (word) {
        case 'Гость':
          return 'гостя';
  ...
  var closeDropdown = function closeDropdown(bar, dropDown) {
    bar.removeClass('border-focus');
    dropDown.addClass('hidden');
  };

  countGuests(this);
  var adults = (0, _jquery.default)('#adults');
  var children = (0, _jquery.default)('#children');
  var infants = (0, _jquery.default)('#infants');
  var sumGuests = +adults.attr('value') + +children.attr('value');
  var sumInfants = +infants.attr('value');
  var bar = (0, _jquery.default)(this).closest('.text-field').find('.text-field__dropdown-default');
  var barGuest = bar.find('.dropdown-form__input');
  var dropGuest = (0, _jquery.default)(this).closest('.common-dropdown');
  var clearBtn = dropGuest.find('.common-dropdown__clear');
  var submitBtn = dropGuest.find('.common-dropdown__submit');
  ...
  if (sumGuests) {
    ...
    setPlaceholder(barGuest, "".concat(sumGuests, " ").concat(declineWord('Гость', sumGuests)));

    if (sumInfants) {
      setAddPlaceholder(barGuest, "".concat(sumInfants, " ").concat(declineWord('Младенец', sumInfants)));
    }
